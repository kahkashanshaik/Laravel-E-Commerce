    ...
    <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
      ...
      <table class="table-auto w-full">
        ...
        <tr>
          ...
          <TableHeaderCell field="first_name" :sorted-field="sortField" :sort-direction="sortDirection"
                           @click="sortCustomers('first_name')">
            Name
          </TableHeaderCell>
          <TableHeaderCell field="email" :sorted-field="sortField" :sort-direction="sortDirection"
                           @click="sortCustomers('email')">
            Email
          </TableHeaderCell>
          <TableHeaderCell field="phone" :sorted-field="sortField" :sort-direction="sortDirection"
                           @click="sortCustomers('phone')">
            Phone
          </TableHeaderCell>
          <TableHeaderCell field="status" :sorted-field="sortField" :sort-direction="sortDirection"
...
function deleteCustomer(customer) {
    if(!confirm(`Are your sure you wanted to delte`)) {
        return;
    }
