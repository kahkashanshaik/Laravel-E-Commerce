    ...
    <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
      ...
      <table class="table-auto w-full">
        ...
        <tr>
          ...
          <TableHeaderCell field="name" :sorted-field="sortField" :sort-direction="sortDirection"
          ...
          <TableHeaderCell field="created_at" :sorted-field="sortField" :sort-direction="sortDirection"
