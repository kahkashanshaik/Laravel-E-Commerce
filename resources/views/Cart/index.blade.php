    ...
    <div class="container lg:w-2/3 xl:w-2/3 mx-auto">
        ...
        <div x-data="{
            ...
            <template x-if="cartItems.length">
                <div>
                    <template x-for="product of cartItems">
                        <div x-data="productItem(product)"
                            class="w-full flex flex-col sm:flex-row items-center gap-4 my-5 p-5 border-gray-200 border">
                    ...
                    <div class="border-t border-gray-300 pt-4">
                        ...
                        <p class="text-gray-500 mb-6">
                         ...
                         <form action="{{ route('cart.checkout') }}" method="post">
                            @csrf
                            <button type="submit" class="btn-primary bg-slate-900 text-white w-full py-3 text-lg">
                                Proceed to Checkout
                            </button>
                        </form>   
                    </div>
