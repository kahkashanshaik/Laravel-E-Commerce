<header x-data="{
    ...
    class="flex justify-between items-center bg-slate-800 shadow-md text-white py-5 px-2">
    <div>
    ...
    <div class="block fixed z-10 top-0 bottom-0 height h-full w-[220px] transition-all bg-slate-900 md:hidden"
        ...
        <ul>
            <li>
                ...
                <small x-shaow="cartItemsCount" x-transition x-text="cartItemsCount" x-cloak
                    class="py-[2px] px-[8px] rounded-full bg-red-500">
                </small>
            </li>
            @if (!Auth::guest())
                <li class="relative" x-data="{ open: false }">
                    <a href="#" class="flex justify-between items-center py-2 px-3 hover:bg-slate-800"
                        @click="open = !open">
                    ...
                    <ul class="z-10 right-0 bg-slate-800 py-2" x-show="open" x-transition>
                        <li>
    ...
    <nav class="hidden md:block">
        <ul class="grid grid-flow-col gap-x-5">
            <li>
        ...
        <ul class="grid grid-flow-col items-center">
            <li class="pr-3">
                <a href="{{ route('cart.index') }}" class="flex relative">
                    ...
                    Cart
                    <small x-shaow="cartItemsCount" x-transition x-text="cartItemsCount" x-cloak
                        class="absolute right-0 -top-5 py-[2px] px-[8px] rounded-full bg-red-500">
                    </small>
                </a>
            </li>
            @if (!Auth::guest())
                <li class="relative" x-data="{ open: false }">
                    ...
                    <ul class="absolute z-10 right-10 bg-slate-800 py-2 w-48" x-show="open"
